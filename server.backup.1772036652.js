  ...
  res.send(`
    <div style="font-family:Arial;max-width:860px;margin:40px auto;line-height:1.4">
      ...
      <p style="color:#666;font-size:12px;margin-top:12px">
        Cambia título/desc/precio + main image + miniaturas cercanas (full color, sin blur).
      </p>
    </div>
  `);
});
  ...
  try {
    ...
    const debug = await page.evaluate(async (p) => {
      ...
      const setImg = (img, url) => {
        ...
        // forzar <picture><source> si existe (evita “gris”/placeholder)
        ...
        // matar efectos “gris / blur / placeholder”
      ...
      for (let t = 0; t < 8; t++) {
        ...
        // MAIN IMG = la más grande en root
        ...
        // THUMBS = chicas debajo del main, asignar en orden
        if (main && p.images?.length) {
      ...
      // congelar scripts para que no se revierta
